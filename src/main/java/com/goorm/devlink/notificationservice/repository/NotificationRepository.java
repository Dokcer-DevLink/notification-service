...
public interface NotificationRepository extends JpaRepository<MentoringNotification,Long> {
    ...
    Optional<MentoringNotification> findByApplyUuidAndNotifyType(String applyUuid, NotifyType notifyType);

    Optional<MentoringNotification> findByNotificationUuid(String notificationUuid);
}
